        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8">
              Discover amazing concerts, sports events, and more
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 text-center">
              ...
              <p className="text-black mb-4">
                Get tickets to exciting sports events
              </p>
              <Link
                href="/sports"
                className="text-blue-600 hover:text-blue-800 font-medium"
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <Link
              href="/events"
              className="inline-block bg-white text-blue-600 font-medium py-3 px-8 rounded-md border-2 border-blue-600 hover:bg-blue-600 hover:text-white transition-colors"
            >
              View All Events
            </Link>
          </div>

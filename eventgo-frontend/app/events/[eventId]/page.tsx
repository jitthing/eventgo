...
export default function EventPage() {
	...
	return (
		<div className="relative min-h-screen bg-white py-12 px-4 sm:px-6 lg:px-8">
			...
			{isGroupBookingOpen && (
				<GroupBookingModal selectedSeats={selectedSeats} eventId={eventId} onClose={closeGroupBooking} totalPrice={totalPrice} availableSeats={availableSeats} eventTitle={event.title} eventDescription={event.description} />
			)}
		</div>
	);
}

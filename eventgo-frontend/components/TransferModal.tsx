...
export default function TransferModal({ ticketId, eventId, eventTitle, seatNumber, onClose }: TransferModalProps) {
	...
	const [recipient, setRecipient] = useState<{ id: number; email: string } | null>(null);
				...
				{!recipient ? (
					...
					<>
						...
						<div className="flex justify-end space-x-3">
							...
							<button onClick={handleTransfer} className="px-5 py-2 rounded bg-green-600 text-white">
